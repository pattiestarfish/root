"""
Game is represented as a tree, with current state stored in tree root; potential moves are child nodes
leaves of tree are game states where game is over
minimax assumes your opponent is using the same algorithm
"""
